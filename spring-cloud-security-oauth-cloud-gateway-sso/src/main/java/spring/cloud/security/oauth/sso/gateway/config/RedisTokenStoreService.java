 ...
 * 续签
 */
public class RedisTokenStoreService extends RedisTokenStore {
    @Autowired
    public ClientDetailsService jdbcClientDetailsService;


    public RedisTokenStoreService(@Qualifier("JedisConnectionFactory") JedisConnectionFactory connectionFactory) {
